...
namespace KafkaFlow_demo.Events;
...
public class AddressModel : ISpecificRecord
{
    public static Avro.Schema _SCHEMA = Avro.Schema.Parse(@"{
                                        ...
                                        'name': 'AddressModel',
                                        'fields': [
                                            { 'name': 'streetLine1', 'type': ['null', 'string'] },
                                            { 'name': 'streetLine2', 'type': ['null', 'string'] },
                                            { 'name': 'streetLine3', 'type': ['null', 'string'] },
                                            { 'name': 'city', 'type': ['null', 'string'] },
                                            { 'name': 'zip', 'type': ['null', 'string'] },
                                            { 'name': 'state', 'type': ['null', 'string'] },
                                            { 'name': 'zipPlusFour', 'type': ['null', 'string'] }
                                        ]
                                    }".Replace("'", "\""));
    ...
    public class RetailCustomerProfileDelta : ISpecificRecord
    {
        public static Avro.Schema _SCHEMA = Avro.Schema.Parse(@"{ 
                        ...
                        'fields': [
                            ...
                            { 'name': 'nameSuffix', 'type': ['null', 'string'] },
                            { 'name': 'address', 'type': 
                                [ 'null', 
                                    {
                                        'type': 'record',
    ...
    public class CommercialCustomerProfileDelta : ISpecificRecord
    {
        public static Avro.Schema _SCHEMA = Avro.Schema.Parse(@"{ 
                        ...
                        'type': 'record',
                        'fields': [
                            { 'name': 'customerName', 'type': ['null', 'string'] },
                            { 'name': 'customerNameAdditional', 'type': ['null', 'string'] },
                            { 'name': 'address', 'type': 
                                [ 'null', 
                                    {
                                        'type': 'record',
    ...
    public class CustomerProfileUpdatedEvent : ISpecificRecord
    {
                ...
                { 'name': 'profile', 'type': [ 'null',
                    ...
                    { 
                        ...
                        'fields': [
                            { 'name': 'customerName', 'type': ['null', 'string'] },
                            { 'name': 'customerNameAdditional', 'type': ['null', 'string'] },
                            { 'name': 'address', 'type': ['null', 'AddressModel'] }
                        ]
        ...
        public void Put(int fieldPos, object fieldValue)
        {
            switch (fieldPos)
            {
                ...
                case 1: ProfileType = Enum.Parse<Enums.ProfileType>((string)fieldValue); break;
